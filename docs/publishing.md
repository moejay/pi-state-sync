...
- Configure npm trusted publishing for GitHub repository `moejay/pi-state-sync` and workflow `publish.yml`.
...
5. Create and push a tag matching the package version, for example `v0.2.0`.
